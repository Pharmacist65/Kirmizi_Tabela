...
- `scripts/generate-game-assets.mjs` creates the project-owned GLB asset catalog.
- `public/assets/game/asset-manifest.json` lists generated models by category: player avatars, customers, staff, buildings, nature, streets, props and interiors.
